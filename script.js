...
app.post('/generate-questions', async (req, res) => {
    ...
    exec(command, async (error, stdout, stderr) => {
        if (error) {
            ...
            return res.status(422).json({ error: `Kunde inte hämta undertexter. Detaljer från svtplay-dl: ${stderr || error.message}` });
        }
...
${srtFileData}`;
        ...
        try {
            ...
            // Dela upp i en array av frågor. Antag att frågor separeras av dubbla radbrytningar eller en siffra följt av punkt.
            ...
            if (aiError instanceof OpenAI.APIError) { // [4]
